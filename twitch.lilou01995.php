...
<html lang="fr">
	...
	<head>
        ...
        <title>Phénécie Twitch</title>
        <meta charset="UTF-8"/>
        <link rel="stylesheet" href="css/twitch.css">
        <link rel="stylesheet" href="css/formulaire.css">
        <link rel="stylesheet" href="css/login.css">
        <link rel="stylesheet" href="css/slide.css">
        <link rel="shortcut icon" href="css/img/Twitch.ico" />
	...
	<body>
        <nav>
            <ul>
              <li class="accueil"><a href=""><div id="Twitch"></div> </div></a></li>
              <li class="space3"><a href=""></a></li>
                ...
                <?php
                 if(!isset($_SESSION['pseudo'])){
                  echo  '<li class="space5"><a href=""></a></li>
                        <li class="connexion"><a href="#"onclick="document.getElementById(\'id03\').style.display=\'block\'">Connexion</a></li>
                        <li class="inscription"><a href="#" onclick="document.getElementById(\'id01\').style.display=\'block\'">Inscription</a></li>';

                }else echo '  <li class="space"><a href=""></a></li>
...
<?php
$getpseudo = $_GET["stream"];
echo'
<iframe class ="screen" src="https://player.twitch.tv/?channel='.$getpseudo.'" frameborder="0" allowfullscreen="true" scrolling="no" height="720" width="1280"></iframe></div></div>
<iframe class ="chat" src="https://www.twitch.tv/embed/'.$getpseudo.'/chat" frameborder="0" scrolling="no" height="720" width="400"></iframe></div>';
